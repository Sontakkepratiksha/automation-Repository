...
import org.apache.poi.ss.usermodel.WorkbookFactory;
	...
	public class Flib  {
		//it is use to store generic reusable method and all the generic reusable methods are non static
			...
			public void writeDataToExce(String excelPath,String sheetName,int rowCount,int cellCount,String data) throws EncryptedDocumentException, IOException
			{
				FileInputStream fis = new FileInputStream(excelPath);
				Workbook wb = WorkbookFactory.create(fis);
				Sheet sheet=wb.getSheet(sheetName);
